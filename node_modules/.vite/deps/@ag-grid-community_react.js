...
var RowComp = ({ rowCtrl, containerType }) => {
  ...
  const showCellsJsx = () => cellCtrls?.map((cellCtrl) => import_react19.default.createElement(
    cellComp_default,
    {
      cellCtrl,
...
var AgGridReactUi = (props) => {
  ...
  return import_react2.default.createElement("div", { style, className: props.className, ref: setRef2 }, context && !context.isDestroyed() ? import_react2.default.createElement(gridComp_default, { context }) : null, portalManager.current?.getPortals() ?? null);
};
