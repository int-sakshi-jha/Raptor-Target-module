...
var require_highcharts = __commonJS({
 ...
 - ${i11}: ${e11}`, r2 && (a2 += encodeURI(i11) + "=" + encodeURI(e11));
      ...
      let { pageLang: tN, win: tz } = B, tR = B.isSafari && tz.Intl && !tz.Intl.DateTimeFormat.prototype.formatRange, tW = class {
        ...
        return Q(B, "setOptions", { options: t10 }), tu(true, tG, t10), t10.time && tF.update(tG.time), t10.lang && "locale" in t10.lang && tF.update({ locale: t10.lang.locale }), t10.lang?.chartTitle && (tG.title = { ...tG.title, text: t10.lang.chartTitle }), tG;
      ...
      let eF = (t10, e10) => {
        if (!t10.div) {
          let i10 = X(t10.element, "class"), s10 = t10.css, o2 = Y("div", i10 ? { className: i10 } : void 0, { position: "absolute", left: `${t10.translateX || 0}px`, top: `${t10.translateY || 0}px`, ...t10.styles, display: t10.display, opacity: t10.opacity, visibility: t10.visibility }, t10.parentGroup?.div || e10);
      ...
      class e9 {
        ...
        render() {
          ...
          }), this.eventsAdded = true), (k2 || !m2.d) && x2?.length ? m2.attr({ d: x2 }) : m2 && (x2 ? (m2.show(), m2.animate({ d: x2 })) : m2.d && (m2.hide(), f2 && (this.label = f2 = f2.destroy()))), u2 && (V(u2.text) || V(u2.formatter)) && x2?.length && t10.width > 0 && t10.height > 0 && !x2.isFlat ? (u2 = tu({ align: i10 && b2 ? "center" : void 0, x: i10 ? !b2 && 4 : 10, verticalAlign: !i10 && b2 ? "middle" : void 0, y: i10 ? b2 ? 16 : 10 : b2 ? 6 : -4, rotation: i10 && !b2 ? 90 : 0, ...b2 ? { inside: true } : {} }, u2), this.renderLabel(u2, x2, b2, a2)) : f2 && f2.hide(), this;
        }
        renderLabel(t10, e10, i10, s10) {
