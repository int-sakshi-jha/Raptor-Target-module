export const kusumMeterToMeterBotTemplate = {
    ...
    powerFactor:
        "IF(SUM(apparentPower), DIV(SUM(activePower), SUM(apparentPower)), 0)",
    ...
    setPoint1: "AVG(setPoint1)",
    setPoint2: "AVG(setPoint2)",
    setPoint3: "AVG(setPoint3)",
};

export const kusumMeterToMeterSoftTags = {
    avgVoltage:
